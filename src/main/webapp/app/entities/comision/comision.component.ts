...
export class ComisionComponent implements OnInit, OnDestroy {
  ...
  loadAll() {
    this.comisionService
      ...
      .subscribe(
        (res: HttpResponse<IComision[]>) => this.paginateComisions(res.body, res.headers),
  ...
  protected paginateComisions(data: IComision[], headers: HttpHeaders) {
